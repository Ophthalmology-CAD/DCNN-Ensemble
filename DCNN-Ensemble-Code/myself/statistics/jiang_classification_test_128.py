# -*-  encoding:utf-8  -*-
def jiang_classification_test_128(net,recurrence_file,surgery_file,image,model,fenlei):
	import numpy as np
	...
	test_other = caffe_root+'myself/external_test_data/web-128/'+recurrence_file
        #test_normal=caffe_root+'myself/twoclass_test_data/'+normal_file
	test_surgery = caffe_root+'myself/external_test_data/web-128/'+surgery_file
	'''
	...
	outfile='web_data_result/'+fenlei+'/resnet_50_train_'+model+'.txt'
