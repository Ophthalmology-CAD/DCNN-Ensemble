...
class SoftmaxParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.SoftmaxParameter) */ {
 public:
  ...
  bool has_pos_cid() const;
  void clear_pos_cid();
  static const int kPosCidFieldNumber = 4;
  ::google::protobuf::int32 pos_cid() const;
  void set_pos_cid(::google::protobuf::int32 value);
  ...
  bool has_pos_mult() const;
  void clear_pos_mult();
  static const int kPosMultFieldNumber = 3;
  float pos_mult() const;
  void set_pos_mult(float value);
 ...
 private:
  ...
  void set_has_axis();
  void clear_has_axis();
  void set_has_pos_mult();
  void clear_has_pos_mult();
  void set_has_pos_cid();
  void clear_has_pos_cid();

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  int engine_;
  ::google::protobuf::int32 pos_cid_;
  ::google::protobuf::int32 axis_;
  float pos_mult_;
  friend struct  protobuf_src_2fcaffe_2fproto_2fcaffe_2eproto::TableStruct;
};
...
// optional float pos_mult = 3 [default = 1];
inline bool SoftmaxParameter::has_pos_mult() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void SoftmaxParameter::set_has_pos_mult() {
  _has_bits_[0] |= 0x00000008u;
}
inline void SoftmaxParameter::clear_has_pos_mult() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void SoftmaxParameter::clear_pos_mult() {
  pos_mult_ = 1;
  clear_has_pos_mult();
}
inline float SoftmaxParameter::pos_mult() const {
  // @@protoc_insertion_point(field_get:caffe.SoftmaxParameter.pos_mult)
  return pos_mult_;
}
inline void SoftmaxParameter::set_pos_mult(float value) {
  set_has_pos_mult();
  pos_mult_ = value;
  // @@protoc_insertion_point(field_set:caffe.SoftmaxParameter.pos_mult)
}

// optional int32 pos_cid = 4 [default = 1];
inline bool SoftmaxParameter::has_pos_cid() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void SoftmaxParameter::set_has_pos_cid() {
  _has_bits_[0] |= 0x00000002u;
}
inline void SoftmaxParameter::clear_has_pos_cid() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void SoftmaxParameter::clear_pos_cid() {
  pos_cid_ = 1;
  clear_has_pos_cid();
}
inline ::google::protobuf::int32 SoftmaxParameter::pos_cid() const {
  // @@protoc_insertion_point(field_get:caffe.SoftmaxParameter.pos_cid)
  return pos_cid_;
}
inline void SoftmaxParameter::set_pos_cid(::google::protobuf::int32 value) {
  set_has_pos_cid();
  pos_cid_ = value;
  // @@protoc_insertion_point(field_set:caffe.SoftmaxParameter.pos_cid)
}
